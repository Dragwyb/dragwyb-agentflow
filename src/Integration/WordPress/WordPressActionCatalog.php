	...
	public static function definitions(): array {
		...
		$definitions[] = array(
			...
			'config_schema' => array(
				...
				'categories' => self::field( 'string', __( 'Categories (comma-separated category IDs)', 'workflow-automate' ) ),
				'tags' => self::field( 'string', __( 'Tags (comma-separated)', 'workflow-automate' ) ),
