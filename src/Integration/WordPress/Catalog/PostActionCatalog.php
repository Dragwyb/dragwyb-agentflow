	...
	public static function definitions( callable $field, callable $option, array $groups ): array {
		...
		$definitions[] = array(
			...
			'config_schema' => array(
				...
				'limit' => $field( 'integer', __( 'Limit', 'workflow-automate' ), array( 'default' => 50, 'description' => __( 'Max posts to return (default 50, max 200). Content is truncated in list results.', 'workflow-automate' ) ) ),
			),
		);
		...
		$definitions[] = array(
			...
			'config_schema' => array(
				...
				'limit' => $field( 'integer', __( 'Limit', 'workflow-automate' ), array( 'default' => 50, 'description' => __( 'Max posts (default 50, max 200).', 'workflow-automate' ) ) ),
			),
		);
		...
		$definitions[] = array(
			...
			'config_schema' => array(
				...
				'post_status' => $field( 'select', __( 'Post Status', 'workflow-automate' ), array( 'required' => true, 'default' => 'draft', 'options' => $postStatusOptions ) ),
		...
		$definitions[] = array(
			...
			'config_schema' => array(
				...
				'post_status' => $field( 'select', __( 'Post Status', 'workflow-automate' ), array( 'default' => '', 'options' => $postStatusOptions ) ),
				'slug' => $field( 'string', __( 'Slug', 'workflow-automate' ) ),
				'date' => $field( 'string', __( 'Date (Y-m-d H:i:s, optional)', 'workflow-automate' ) ),
				'date_gmt' => $field( 'string', __( 'Date GMT (Y-m-d H:i:s, optional)', 'workflow-automate' ) ),
				'parent_id' => $field( 'string', __( 'Parent Post ID', 'workflow-automate' ) ),
		...
		$definitions[] = array(
			...
			'config_schema' => array(
				'post_id' => $field( 'string', __( 'Post ID', 'workflow-automate' ), array( 'required' => true ) ),
				'post_status' => $field( 'select', __( 'Post Status', 'workflow-automate' ), array( 'required' => true, 'default' => 'publish', 'options' => $postStatusOptions ) ),
			),
		);
		...
		$definitions[] = array(
			...
			'config_schema' => array(
				'post_id' => $field( 'string', __( 'Post ID', 'workflow-automate' ), array( 'required' => true ) ),
				'comment' => $field( 'string', __( 'Comment', 'workflow-automate' ), array( 'required' => true, 'multiline' => true ) ),
