	...
	public static function definitions( callable $field, callable $option, array $groups ): array {
		...
		$definitions[] = array(
			...
			'config_schema' => array(
				...
				'user_role' => $field( 'string', __( 'User Role', 'workflow-automate' ), array( 'required' => true, 'default' => 'subscriber' ) ),
		...
		$definitions[] = array(
			...
			'method_args' => array(),
			'config_schema' => array(
				'limit' => $field( 'integer', __( 'Limit', 'workflow-automate' ), array( 'default' => 50, 'description' => __( 'Max users to return (default 50, max 200).', 'workflow-automate' ) ) ),
			),
		);
