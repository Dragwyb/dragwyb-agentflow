...
class Capabilities {
	 ...
	 */
	public const ACCESS = 'aiawa_access';

	public const MANAGE_WORKFLOWS = 'aiawa_manage_workflows';

	public const MANAGE_RUNS = 'aiawa_manage_runs';

	public const MANAGE_CONNECTIONS = 'aiawa_manage_connections';

	public const MANAGE_WEBHOOKS = 'aiawa_manage_webhooks';

	public const MANAGE_SETTINGS = 'aiawa_manage_settings';
	 ...
	 * given only `aiawa_manage_runs` still sees the top-level menu).
	 *
