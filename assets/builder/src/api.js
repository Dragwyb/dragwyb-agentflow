...
export function fetchWorkflow(id) {
	return apiFetch({ path: `/dragwyb_af/v1/workflows/${id}` });
}
...
export function updateWorkflow(id, data) {
	return apiFetch({
		path: `/dragwyb_af/v1/workflows/${id}`,
		method: 'PUT',
		data,
	});
}
...
export function fetchNodeTypes() {
	return apiFetch({ path: '/dragwyb_af/v1/node-types' });
}
...
export function fetchTriggerSampleSchema(triggerType, formId = '') {
	...
	return apiFetch({
		path: `/dragwyb_af/v1/trigger-sample-schema?${params.toString()}`,
	});
}
...
export function fetchConnections() {
	return apiFetch({ path: '/dragwyb_af/v1/connections' });
}
...
export function createConnection(data) {
	return apiFetch({
		path: '/dragwyb_af/v1/connections',
		method: 'POST',
		data,
	});
}
...
export function fetchGoogleOAuthAuthorizeUrl(connectionId, options = {}) {
	...
	return apiFetch({
		path: `/dragwyb_af/v1/connections/${connectionId}/oauth/authorize-url${
			query ? `?${query}` : ''
		}`,
	});
}
...
export function getBootstrap() {
	return (
		window.dragwybAFBuilderSettings || {
			workflowId: 0,
			listUrl: '',
			connectionsUrl: '',
			aiCredentialsUrl: '',
...
export function fetchAiProviderModels(provider, nodeType = '') {
	...
	return apiFetch({
		path: `/dragwyb_af/v1/ai/models?${params.toString()}`,
	});
}
...
export function fetchAiProviderStatus() {
	return apiFetch({ path: '/dragwyb_af/v1/ai/status' });
}
...
export function saveAiProviderCredentials(provider, apiKey) {
	return apiFetch({
		path: '/dragwyb_af/v1/ai/credentials',
		method: 'POST',
		data: {
			provider,
			api_key: apiKey,
...
export function clearAiProviderCredentials(provider) {
	...
	return apiFetch({
		path: `/dragwyb_af/v1/ai/credentials?${params.toString()}`,
		method: 'DELETE',
	});
}
...
export function startTestListen(id) {
	return apiFetch({
		path: `/dragwyb_af/v1/workflows/${id}/test/listen`,
		method: 'POST',
	});
}
...
export function fetchTestStatus(id) {
	return apiFetch({ path: `/dragwyb_af/v1/workflows/${id}/test/status` });
}
...
export function clearTestSample(id) {
	return apiFetch({
		path: `/dragwyb_af/v1/workflows/${id}/test/sample`,
		method: 'DELETE',
	});
}
...
export function testWorkflowNode(id, data) {
	return apiFetch({
		path: `/dragwyb_af/v1/workflows/${id}/test/node`,
		method: 'POST',
		data,
	});
}
...
export function runWorkflow(id, data = {}) {
	return apiFetch({
		path: `/dragwyb_af/v1/workflows/${id}/run`,
		method: 'POST',
		data,
	});
}
...
export function sendWorkflowChat(id, data) {
	return apiFetch({
		path: `/dragwyb_af/v1/workflows/${id}/chat`,
		method: 'POST',
		data,
	});
}
